...
class Diameter {
  ...
  Diameter.fromJson(Map<String, dynamic> json) {
    final meter = json['meters'] ?? '0.0';
    final feets = json['feet'] ?? '0.0';
    meters = double.parse(meter.toString());
    feet = double.parse(feets.toString());
  }
...
class FirstStage {
  ...
  FirstStage.fromJson(Map<String, dynamic> json) {
    ...
    fuelAmountTons = double.parse(json['fuel_amount_tons'].toString());
...
class Payloads {
  ...
  Payloads.fromJson(Map<String, dynamic> json) {
    compositeFairing = json['composite_fairing'] != null
        ...
        : null;
    option1 = json['option_1'].toString();
  }
...
class Engines {
  ...
  Engines.fromJson(Map<String, dynamic> json) {
    ...
    propellant1 = json['propellant_1'].toString();
    propellant2 = json['propellant_2'].toString();
    thrustToWeight = double.parse(json['thrust_to_weight'].toString());
  }
