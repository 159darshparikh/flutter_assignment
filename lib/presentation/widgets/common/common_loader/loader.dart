...
import '/presentation/widgets/common/common_loader/build_dot.dart';
...
class _BuildSpinnerState extends State<Loader>
      ...
      child: AnimatedBuilder(
        ...
        builder: (_, __) => SizedBox(
          ...
          child: _animationController.value <= 0.28
              ...
              /// at initial state, the dots are just coming on screen
              ? Stack(
              ...
              /// after some time, it will start rotating.
              Transform.rotate(
                  angle: _rotationAnimation.value,
                  child: Stack(
                    alignment: Alignment.center,
                    children: <Widget>[
                      /// while rotating, it will build some different king of dot.
                      _buildLaterDot(
                        0 + angle30,
                        const Interval(
                          0.80,
